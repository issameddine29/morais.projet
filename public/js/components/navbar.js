...
(function() {
    ...
    async function loadNavbar() {
        ...
        try {
            ...
            // Fallback : navbar simplifiée en cas d'erreur
            container.innerHTML = `
    ...
    function initBurgerMenu() {
        ...
        const navbarOverlay = document.getElementById('mc-navbar-overlay'); // ✅ AJOUTÉ
        ...
        navLinks.forEach(link => {
            link.addEventListener('click', () => {
                ...
                burgerBtn.classList.remove(CONFIG.activeClass);
                burgerBtn.setAttribute('aria-expanded', 'false');
                if (navbarOverlay) navbarOverlay.classList.remove(CONFIG.activeClass); // ✅ AJOUTÉ
                document.body.style.overflow = '';
            });
        });
     ...
     * ✅ Click uniquement - reste ouvert jusqu'au clic sur un service
     */
    function initDropdownMenu() {
        ...
        dropdownItems.forEach(item => {
            ...
            // ✅ AJOUTÉ : Fermer au clic sur un item du menu
